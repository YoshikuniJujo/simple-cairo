...
cairoMoveTo, cairoLineTo, cairoRelLineTo :: CairoT s -> #{type double} -> #{type double} -> IO ()
...
cairoArc :: (CairoT s) -> #{type double} -> #{type double} ->
...
cairoRelCurveTo :: (CairoT s) -> #{type double} -> #{type double} ->
...
cairoRectangle :: CairoT s -> #{type double} -> #{type double} -> #{type double} -> #{type double} -> IO ()
